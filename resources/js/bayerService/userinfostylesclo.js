let namereginon = document.getElementById('m_userinfosclo_updatename_region_buer');
let nameon = document.getElementById('m_userinfosclo_updatename_region_name');
let contentname = document.getElementById('m_userinfosclo_contentname');
let contentday = document.getElementById('m_userinfosclo_contentday');
let bday = document.getElementById('m_userinfosclo_updatename_region_bday');
let name1 = document.getElementById('m_userinfosclo_updatename_region_plfname1')
let name2 = document.getElementById('m_userinfosclo_updatename_region_plfname2')
let inname1 = document.getElementById('m_userinfosclo_updatename_region_infname1')
let inname2 = document.getElementById('m_userinfosclo_updatename_region_infname2')
